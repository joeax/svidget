...
> Note: Version 0.3.0 will be releasing soon (hopefully by end of April). I am almost done rewriting all the unit tests, and have fixed a lot of small issues, made performance improvements, and have opened up much of the internals like type conversion as public APIs. In the mean time please open any issues you see. 
