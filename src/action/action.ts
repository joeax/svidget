...
interface ActionProps extends BaseProps, ActionOptions {
	bindingFunc?: string;
}
 ...
 */
export class Action extends ObjectBase<ActionProps> {
...
/**
   ...
   *                you are using.
   */
  constructor(name: string, options: ActionOptions, parent: Widget) {



	  super(parent);
	// = function (name, options, parent) {
